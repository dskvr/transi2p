...
# sudo iptables -t nat -A OUTPUT -m owner --uid-owner $_i2p_uid -j RETURN
...
# #redirect all other output to i2p's TransPort
# sudo iptables -t nat -A OUTPUT -p tcp --syn -d $_i2p_range -j REDIRECT --to-ports $_i2p_port

# #redirect all other output to Tor's TransPort
# sudo iptables -t nat -A OUTPUT -p tcp --syn -j REDIRECT --to-ports $_tor_port
...
# sudo iptables -A OUTPUT -m owner --uid-owner $_i2p_uid -j ACCEPT
